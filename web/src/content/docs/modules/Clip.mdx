...
##### add_new_notes<span class="meth-sig">(notes: Iterable[<a href="/LiveAPI/modules/clip/#midinotespecification">MidiNoteSpecification</a>]) -> <a href="/LiveAPI/modules/base/#intu64vector">IntU64Vector</a></span>
...
##### add_warp_marker<span class="meth-sig">(warp_marker: <a href="/LiveAPI/modules/clip/#warpmarker">WarpMarker</a>) -> None</span>

Available for AudioClips only. Adds the specified warp marker, if possible.

##### apply_note_modifications<span class="meth-sig">(notes: <a href="/LiveAPI/modules/clip/#midinotevector">MidiNoteVector</a>) -> None</span>
...
##### automation_envelope<span class="meth-sig">(device_parameter: <a href="/LiveAPI/modules/deviceparameter/#deviceparameter">DeviceParameter</a>) -> <a href="/LiveAPI/modules/envelope/#envelope">Envelope</a></span>
...
##### beat_to_sample_time<span class="meth-sig">(beat_time: float) -> float</span>

Available for AudioClips only. Converts the given beat time to sample time. Raises an error if the sample is not warped.

##### clear_all_envelopes<span class="meth-sig">() -> None</span>

Clears all envelopes for this clip.

##### clear_envelope<span class="meth-sig">(device_parameter: <a href="/LiveAPI/modules/deviceparameter/#deviceparameter">DeviceParameter</a>) -> None</span>

Clears the envelope of this clips given parameter.

##### create_automation_envelope<span class="meth-sig">(device_parameter: <a href="/LiveAPI/modules/deviceparameter/#deviceparameter">DeviceParameter</a>) -> <a href="/LiveAPI/modules/envelope/#envelope">Envelope</a></span>
...
##### crop<span class="meth-sig">() -> None</span>
...
##### deselect_all_notes<span class="meth-sig">() -> None</span>

De-selects all notes present in the clip.

##### duplicate_loop<span class="meth-sig">() -> None</span>
...
##### duplicate_notes_by_id<span class="meth-sig">(note_ids: Iterable[int], destination_time: float | None = None, transposition_amount: int = 0) -> <a href="/LiveAPI/modules/base/#intu64vector">IntU64Vector</a></span>
...
##### duplicate_region<span class="meth-sig">(region_start: float, region_length: float, destination_time: float, pitch: int = -1, transposition_amount: int = 0) -> None</span>
...
##### fire<span class="meth-sig">() -> None</span>

(Re)Start playing this Clip.

##### get_all_notes_extended<span class="meth-sig">() -> <a href="/LiveAPI/modules/clip/#midinotevector">MidiNoteVector</a></span>
...
##### get_notes<span class="meth-sig">(from_time: float, from_pitch: int, time_span: float, pitch_span: int) -> tuple[tuple[int, float, float, float, bool], ...]</span>
...
##### get_notes_by_id<span class="meth-sig">(note_ids: Iterable[int]) -> <a href="/LiveAPI/modules/clip/#midinotevector">MidiNoteVector</a></span>

Return a list of MIDI notes matching the given note IDs.

##### get_notes_extended<span class="meth-sig">(from_pitch: int, pitch_span: int, from_time: float, time_span: float) -> <a href="/LiveAPI/modules/clip/#midinotevector">MidiNoteVector</a></span>
...
##### get_selected_notes<span class="meth-sig">() -> tuple[tuple[int, float, float, float, bool], ...]</span>
...
##### get_selected_notes_extended<span class="meth-sig">() -> <a href="/LiveAPI/modules/clip/#midinotevector">MidiNoteVector</a></span>
...
##### quantize<span class="meth-sig">(quantization_grid: <a href="/LiveAPI/modules/clip/#gridquantization">GridQuantization</a> | int, amount: float) -> None</span>

Quantize all notes in a clip or align warp markers.

##### quantize_pitch<span class="meth-sig">(note: int, quantization_grid: <a href="/LiveAPI/modules/clip/#gridquantization">GridQuantization</a> | int, amount: float) -> None</span>

Quantize all the notes of a given pitch. Raises an error on audio clips.

##### remove_notes<span class="meth-sig">(from_time: float, from_pitch: int, time_span: float, pitch_span: int) -> None</span>

Delete all notes starting in the given pitch- and time range.

##### remove_notes_by_id<span class="meth-sig">(note_ids: Iterable[int]) -> None</span>
...
##### remove_notes_extended<span class="meth-sig">(from_pitch: int, pitch_span: int, from_time: float, time_span: float) -> None</span>
...
##### remove_warp_marker<span class="meth-sig">(beat_time: float) -> None</span>

Available for AudioClips only. Removes the specified warp marker, if possible.

##### replace_selected_notes<span class="meth-sig">(notes: tuple[tuple[int, float, float, float, bool], ...]) -> None</span>
...
##### sample_to_beat_time<span class="meth-sig">(sample_time: float) -> float</span>

Available for AudioClips only. Converts the given sample time to beat time. Raises an error if the sample is not warped.

##### scrub<span class="meth-sig">(scrub_position: float) -> None</span>
...
##### seconds_to_sample_time<span class="meth-sig">(seconds: float) -> float</span>

Available for AudioClips only. Converts the given seconds to sample time. Raises an error if the sample is warped.

##### select_all_notes<span class="meth-sig">() -> None</span>

Selects all notes present in the clip.

##### select_notes_by_id<span class="meth-sig">(note_ids: Iterable[int]) -> None</span>
...
##### set_notes<span class="meth-sig">(notes: tuple[tuple[int, float, float, float, bool], ...]) -> None</span>
...
##### stop_scrub<span class="meth-sig">() -> None</span>
...
##### hide_envelope<span class="meth-sig">() -> None</span>

Hide the envelope view.

##### select_envelope_parameter<span class="meth-sig">(device_parameter: <a href="/LiveAPI/modules/deviceparameter/#deviceparameter">DeviceParameter</a>) -> None</span>

Select the given device parameter in the envelope view.

##### show_envelope<span class="meth-sig">() -> None</span>

Show the envelope view.

##### show_loop<span class="meth-sig">() -> None</span>
