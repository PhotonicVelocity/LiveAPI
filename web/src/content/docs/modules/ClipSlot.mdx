...
##### create_audio_clip<span class="meth-sig">(file_path: str) -> <a href="/LiveAPI/modules/clip/#clip">Clip</a></span>
...
##### create_clip<span class="meth-sig">(length: float) -> <a href="/LiveAPI/modules/clip/#clip">Clip</a></span>
...
##### delete_clip<span class="meth-sig">() -> None</span>

Removes the clip contained in the slot. Raises an exception if the slot was empty.

##### duplicate_clip_to<span class="meth-sig">(target_clip_slot: <a href="/LiveAPI/modules/clipslot/#clipslot">ClipSlot</a>) -> None</span>
