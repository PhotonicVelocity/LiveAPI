...
##### create_audio_clip<span class="meth-sig">(file_path: str, position: float) -> <a href="/LiveAPI/modules/clip/#clip">Clip</a></span>
...
##### create_midi_clip<span class="meth-sig">(start_time: float, length: float) -> <a href="/LiveAPI/modules/clip/#clip">Clip</a></span>
...
##### create_take_lane<span class="meth-sig">() -> <a href="/LiveAPI/modules/takelane/#takelane">TakeLane</a></span>

Create a new TakeLane for this track.

##### delete_clip<span class="meth-sig">(clip: <a href="/LiveAPI/modules/clip/#clip">Clip</a>) -> None</span>
...
##### duplicate_clip_slot<span class="meth-sig">(index: int) -> int</span>
...
##### duplicate_clip_to_arrangement<span class="meth-sig">(clip: <a href="/LiveAPI/modules/clip/#clip">Clip</a>, destination_time: float) -> <a href="/LiveAPI/modules/clip/#clip">Clip</a></span>
...
##### jump_in_running_session_clip<span class="meth-sig">(beats: float) -> None</span>
...
##### select_instrument<span class="meth-sig">() -> bool</span>
