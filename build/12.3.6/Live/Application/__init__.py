...
class ControlDescriptionVector:
    ...
    def extend(self, value: ControlDescription) -> None:
        ...
...
class ControlSurfaceProxy:
    ...
    def send_midi(self, midi_bytes: tuple) -> None:
        ...

    def send_value(self, values: tuple) -> None:
        ...
...
class UnavailableFeatureVector:
    ...
    def extend(self, value: UnavailableFeature) -> None:
        ...
