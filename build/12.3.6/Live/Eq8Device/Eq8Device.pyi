...
class Eq8Device:
    ...
    class View:
        ...
        def add_selected_band_listener(self, callback: Callable) -> None:
            """
        ...
        def remove_selected_band_listener(self, callback: Callable) -> None:
            """
        ...
        def selected_band_has_listener(self, callback: Callable) -> bool:
            """
    ...
    def add_edit_mode_listener(self, callback: Callable) -> None:
        """
        Add a listener function or method, which will be called as soon as the
    ...
    def add_global_mode_listener(self, callback: Callable) -> None:
        """
        Add a listener function or method, which will be called as soon as the
    ...
    def add_oversample_listener(self, callback: Callable) -> None:
        """
        Add a listener function or method, which will be called as soon as the
    ...
    def edit_mode_has_listener(self, callback: Callable) -> bool:
        """
        Returns true, if the given listener function or method is connected
    ...
    def oversample_has_listener(self, callback: Callable) -> bool:
        """
        Returns true, if the given listener function or method is connected
    ...
    def remove_edit_mode_listener(self, callback: Callable) -> None:
        """
        Remove a previously set listener function or method from
        property "edit_mode".
        """
    ...
    def remove_global_mode_listener(self, callback: Callable) -> None:
        """
        Remove a previously set listener function or method from
    ...
    def remove_oversample_listener(self, callback: Callable) -> None:
        """
        Remove a previously set listener function or method from
        property "oversample".
        """
