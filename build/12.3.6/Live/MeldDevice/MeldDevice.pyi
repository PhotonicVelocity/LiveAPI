...
class MeldDevice:
    ...
    def add_selected_engine_listener(self, callback: Callable) -> None:
        """
        Add a listener function or method, which will be called as soon as the
    ...
    def add_unison_voices_listener(self, callback: Callable) -> None:
        """
        Add a listener function or method, which will be called as soon as the
    ...
    def remove_selected_engine_listener(self, callback: Callable) -> None:
        """
        Remove a previously set listener function or method from
    ...
    def remove_unison_voices_listener(self, callback: Callable) -> None:
        """
        Remove a previously set listener function or method from
    ...
    def selected_engine_has_listener(self, callback: Callable) -> bool:
        """
        Returns true, if the given listener function or method is connected
    ...
    def unison_voices_has_listener(self, callback: Callable) -> bool:
        """
        Returns true, if the given listener function or method is connected
