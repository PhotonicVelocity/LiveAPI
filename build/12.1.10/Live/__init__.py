...
"""Stub generated for Ableton Version  12.1.10"""
        """
...
class Track(ModuleType):
    ...
    class Track(object):
        ...
        def create_midi_clip(self, arg2: float, arg3: float) -> None:
            """
            Creates an empty MIDI clip and inserts it into the arrangement at the specified time. Throws an error when called on a non-MIDI track or a frozen track, when the specified time is outside the [0., 1576800.] range, or when the track is currently being recorded into. C++ signature :  void create_midi_clip(TTrackPyHandle,double,double)
            :param arg2: arg2
            :type arg2: float
            :param arg3: arg3
            :type arg3: float
