...
_ARG_NAME_OVERRIDES: dict[str, dict[str, str]] = {
    ...
    "Live.Application.Application.View.scroll_view": {"arg2": "direction", "arg3": "identifier", "arg4": "animate"},
    "Live.Application.Application.View.zoom_view": {"arg2": "direction", "arg3": "identifier", "arg4": "animate"},
    # Fire button state
    ...
    "Live.Clip.Clip.move_playing_pos": {"arg2": "amount"},
    ...
    "Live.Device.Device.store_chosen_bank": {"arg2": "bank_index", "arg3": "sub_bank_index"},
    ...
    "Live.Song.Song.jump_by": {"arg2": "amount"},
    "Live.Song.Song.scrub_by": {"arg2": "amount"},
    "Live.TakeLane.TakeLane.create_audio_clip": {"arg2": "file_path", "arg3": "time"},
    "Live.TakeLane.TakeLane.create_midi_clip": {"arg2": "time", "arg3": "length"},
    "Live.Track.Track.create_audio_clip": {"arg2": "file_path", "arg3": "time"},
    "Live.Track.Track.create_midi_clip": {"arg2": "time", "arg3": "length"},
    "Live.Track.Track.delete_clip": {"arg2": "clip"},
    "Live.Track.Track.jump_in_running_session_clip": {"arg2": "amount"},
