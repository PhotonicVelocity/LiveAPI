...
def render_module_page(
    ...
    # excluded from Starlight's autogenerated sidebar group — used for
    # foundation pages (LomObject, Listener) that we hoist to a manual
    # entry above the `Modules` group via `astro.config.mjs`. Without
    # the hide, they'd appear twice in the sidebar (once at the top,
    # once alphabetically inside Modules).
