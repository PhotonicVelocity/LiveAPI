...
| `frequency_dial_mode`       | `int`                              | `yes`    | `yes`      | Return the current frequency dial mode index.                                    |
| `frequency_dial_mode_list`  | `tuple[str, Ellipsis]`             | `no`     | `yes`      | Return the current frequency dial mode list.                                     |
...
| `midi_gate`                 | `int`                              | `yes`    | `yes`      | Return the current midi gate index.                                              |
| `midi_gate_list`            | `tuple[str, Ellipsis]`             | `no`     | `yes`      | Return the current midi gate list.                                               |
| `mod_mode`                  | `int`                              | `yes`    | `yes`      | Return the current mod mode index.                                               |
| `mod_mode_list`             | `tuple[str, Ellipsis]`             | `no`     | `yes`      | Return the current mod mode list.                                                |
| `mono_poly`                 | `int`                              | `yes`    | `yes`      | Return the current mono poly mode index.                                         |
| `mono_poly_list`            | `tuple[str, Ellipsis]`             | `no`     | `yes`      | Return the current mono poly mode list.                                          |
...
| `pitch_bend_range`          | `int`                              | `yes`    | `yes`      | Return the current pitch bend range.                                             |
| `pitch_mode`                | `int`                              | `yes`    | `yes`      | Return the current pitch mode index.                                             |
| `pitch_mode_list`           | `tuple[str, Ellipsis]`             | `no`     | `yes`      | Return the current pitch mode list.                                              |
| `polyphony`                 | `int`                              | `yes`    | `yes`      | Return the current polyphony.                                                    |
