...
| [`env_listen`](#env_listen)                               | `bool`                             | `get`/`set`/`listen` |
...
| [`routing_mode_index`](#routing_mode_index)               | `int`                              | `get`/`set`/`listen` |
| [`routing_mode_list`](#routing_mode_list)                 | `tuple[str, Ellipsis]`             | `get`                |
