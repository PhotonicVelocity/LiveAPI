...
| `pitch_bend_range`          | `int`                              | `yes`    | `yes`      | Return the pitch bend range for MIDI pitch mode.                                 |
| `pitch_mode_index`          | `int`                              | `yes`    | `yes`      | Return the current pitch mode index.                                             |
| `pitch_mode_list`           | `tuple[str, Ellipsis]`             | `no`     | `no`       | Return the current pitch mode list.                                              |
