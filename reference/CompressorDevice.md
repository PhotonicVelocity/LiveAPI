...
- **Primary:** `Live/classes/devices/CompressorDevice.py` (stub dump)
- **Secondary:** `MaxForLive/compressordevice.md`
- **Probes:** 2026-02-25 (bridge type, class_name, routing serialization, listener support)
...
- ~~What is the structure of the routing channel/type objects?~~ **Resolved:** Same
  `RoutingType`/`RoutingChannel` structures as track routing, with `_pfl_type` markers.
...
| ---------------------------------- | ---------------------- | ---------------- | ---------- | --------------- | ------------------------------------------------------ |
| `available_input_routing_channels` | `list[RoutingChannel]` | —                | `yes`      | `<11`           | Available source channels for sidechain input routing. |
| `available_input_routing_types`    | `list[RoutingType]`    | —                | `yes`      | `<11`           | Available source types for sidechain input routing.    |
| `input_routing_channel`            | `RoutingChannel`       | `RoutingChannel` | `yes`      | `<11`           | Currently selected sidechain source channel.           |
| `input_routing_type`               | `RoutingType`          | `RoutingType`    | `yes`      | `<11`           | Currently selected sidechain source type.              |
