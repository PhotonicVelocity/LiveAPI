...
- **Primary:** `Live/classes/devices/SpectralResonatorDevice.py` (stub dump)
- **Secondary:** `MaxForLive/spectralresonatordevice.md`
...
- All 5 `*_list` properties serialize as plain `list[str]` through the bridge (StringVector → list).
...
- `frequency_dial_mode_list` = `['ModulationHertz', 'ModulationBeat8th']` (internal names, not UI labels).
...
| -------------------------- | -------------- | ----------- | ---------- | --------------- | ---------------------------------------------------------------- |
| `frequency_dial_mode`      | `int`          | `int`       | `yes`      | `<11`           | Freq dial mode: 0 = Hertz, 1 = MIDI note.                        |
| `frequency_dial_mode_list` | `StringVector` | —           | `yes`      | `<11`           | List of available frequency dial mode names.                     |
| `midi_gate`                | `int`          | `int`       | `yes`      | `<11`           | MIDI gate switch: 0 = Off, 1 = On.                               |
| `midi_gate_list`           | `StringVector` | —           | `yes`      | `<11`           | List of available MIDI gate options.                             |
| `mod_mode`                 | `int`          | `int`       | `yes`      | `<11`           | Modulation mode: 0 = None, 1 = Chorus, 2 = Wander, 3 = Granular. |
| `mod_mode_list`            | `StringVector` | —           | `yes`      | `<11`           | List of available modulation mode names.                         |
| `mono_poly`                | `int`          | `int`       | `yes`      | `<11`           | Mono/Poly switch: 0 = Mono, 1 = Poly.                            |
| `mono_poly_list`           | `StringVector` | —           | `yes`      | `<11`           | List of available mono/poly options.                             |
| `pitch_bend_range`         | `int`          | `int`       | `yes`      | `<11`           | Pitch bend range in semitones (0–24). Settable.                  |
| `pitch_mode`               | `int`          | `int`       | `yes`      | `<11`           | Pitch mode: 0 = Internal, 1 = MIDI.                              |
| `pitch_mode_list`          | `StringVector` | —           | `yes`      | `<11`           | List of available pitch mode names.                              |
| `polyphony`                | `int`          | `int`       | `yes`      | `<11`           | Polyphony voice count index.                                     |
