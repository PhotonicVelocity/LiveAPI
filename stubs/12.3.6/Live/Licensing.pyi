...
class PythonLicensingBridge:
    ...
    def get_startup_dialog(self, authorize_callable: Callable, authorize_later_callable: Callable, /) -> StartupDialog:
    ...
    def process_license_response(self, license_response_lines: list[str], /) -> UnlockStatus:
    ...
    def set_network_timer(self, callback: Callable | None, interval_in_ms: int, /) -> None:
...
class StartupDialog:
    ...
    def set_notification_message(self, notification_text: str, show_progress_bar: bool, /) -> None:
        ...
