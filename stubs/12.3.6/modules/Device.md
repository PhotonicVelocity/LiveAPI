...
- name: script_index
  ...
  refinement:
    name:
      probed: arg2
      sources:
      - '[M4L] external/max-for-live-docs/9.0/device.md names the parameter `script_index`.'
- name: bank_index
  type: int
  refinement:
    name:
      probed: arg3
      sources:
      - '[M4L] external/max-for-live-docs/9.0/device.md names the parameter `bank_index`.'
returns:
  type: None
