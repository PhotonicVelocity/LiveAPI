...
refinement:
  type:
    ...
    confidence: high
    sources:
    - '[docstring] "Get/set access to the color index of the scene. Can be None for no color." Explicit nullability documented
      in raw_doc.'
```
...
- name: state
  ...
  refinement:
    name:
      probed: arg2
      sources:
      - '[M4L] external/max-for-live-docs/9.0/scene.md names the parameter `state`.'
returns:
  type: None
