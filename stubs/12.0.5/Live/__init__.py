...
class Application(ModuleType):
    ...
    class Application(object):
        ...
        def show_on_the_fly_message(self, message: str, buttons: int=Application.MessageButtons.OK_BUTTON, enable_markup: bool=False, show_success_icon: bool=False) -> int:
            """
...
class Song(ModuleType):
    ...
    class Song(object):
        ...
        def root_note(self) -> int:
            """
            Set and access the root note (i.e. key) of the song. The root note can be a number between 0 and 11, with 0 corresponding to C and 11 corresponding to B.
            """
            ...
    ...
    class TuningSystem(object):
        ...
        def maximum_note(self) -> tuple:
            """
            Returns a tuple where the first entry is the index within the pseudo octave andthe second entry is the octave or the maximum note in the tuning system.
            """
            ...
        ...
        def minimum_note(self) -> tuple:
            """
            Returns a tuple where the first entry is the index within the pseudo octave andthe second entry is the octave or the minimum note in the tuning system.
            """
            ...
